...
int main(int argc, char *argv[])
{
	...
	else
	{
		...
		graph_path = "F:/Yun/Bio/fenceng/20180103/newCommunity/reduceMethod/ReduceP/2/";
	}
	...
	layer1.load(graph_path + "Layer1.gen");
	layer1reduce.load(graph_path + "Layer1.gen");
	Communities layer2, layer2reduce;
	layer2.load(graph_path + "Layer2.gen");
	layer2reduce.load(graph_path + "Layer2.gen");
